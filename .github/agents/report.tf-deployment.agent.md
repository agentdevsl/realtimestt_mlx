...
tools:
  [
    ...
    'runSubagent',
    'problems',
    'terraform-mcp-server/get_run_details',
    'terraform-mcp-server/get_workspace_details',
    'terraform-mcp-server/list_runs',
    'terraform-mcp-server/list_terraform_orgs',
    'terraform-mcp-server/list_terraform_projects',
    'terraform-mcp-server/list_variable_sets',
    'terraform-mcp-server/list_workspace_variables',
    'terraform-mcp-server/list_workspaces',
    'terraform-mcp-server/search_private_providers',
    'terraform-mcp-server/search_providers',
    'terraform-mcp-server/create_run',
